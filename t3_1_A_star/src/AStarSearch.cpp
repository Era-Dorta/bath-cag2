...
MapSearchNode *AStarSearch::GetOpenListStart() {
	float f, g, h;
	return GetOpenListStart(f, g, h);
}

MapSearchNode *AStarSearch::GetOpenListStart(float &f, float &g, float &h) {
...
MapSearchNode *AStarSearch::GetOpenListNext() {
	float f, g, h;
	return GetOpenListNext(f, g, h);
}

MapSearchNode *AStarSearch::GetOpenListNext(float &f, float &g, float &h) {
	iterDbgOpen++;
	if (iterDbgOpen != m_OpenList.end()) {
		f = (*iterDbgOpen)->f;
		g = (*iterDbgOpen)->g;
...
MapSearchNode *AStarSearch::GetClosedListStart() {
	float f, g, h;
	return GetClosedListStart(f, g, h);
}

MapSearchNode *AStarSearch::GetClosedListStart(float &f, float &g, float &h) {
...
MapSearchNode *AStarSearch::GetClosedListNext() {
	float f, g, h;
	return GetClosedListNext(f, g, h);
}

MapSearchNode *AStarSearch::GetClosedListNext(float &f, float &g, float &h) {
	iterDbgClosed++;
	if (iterDbgClosed != m_ClosedList.end()) {
		f = (*iterDbgClosed)->f;
		g = (*iterDbgClosed)->g;
