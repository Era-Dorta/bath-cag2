...
For each thread in the patch a tangent curved is defined, this curve will be sampled at fixed positions giving the normal direction in that position, with it the BRDF will be evaluated and the total outgoing radiance can be computed as follows,
