...
where $u$ is a unit height Gaussian function with standard deviation between $15$\textdegree and $25$\textdegree; an in depth discussion on how to compute $u$ can be found in \citeauthor{Ashikmin2000} \cite{Ashikmin2000} Section 4.2 New Shadowing Term.
