...
Our implementation only includes the basic light scattering proposed by the authors \cite{Sadeghi2013}; a clear future work would be to add all the remaining features in our code.

Model fails at close ups.

A drawback of this model is a complicated application of parameter optimization techniques; therefore, derivation of appropriate parameters of individual threads is left completely to users and their experience
...
Importance sampling \cite{Wang2014, Mizutani2014}.
