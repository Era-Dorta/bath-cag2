...
\note{Highlight more teamwork in skin project}
\begin{multicols}{2}
\begin{itemize}
...
\begin{center}
\begin{figure}
\movie[width=0.48\textwidth, autostart, loop]
        {\includegraphics[width=0.5\textwidth]{img/cloth_render}}{img/cloth_render_video.mp4}
~
\movie[width=0.48\textwidth, autostart, loop]
        {\includegraphics[width=0.3\textwidth]{img/cloth_render}}{img/cloth_render_video.mp4}
...
\note{Interest started with videogames, evolved to rendering and research, as you know rendering has bla bla problems}
\subsection{ }
...
\note{As you know, the rendering equation bla bla}
\begin{equation*}  
...
%\caption*{\tiny{Image taken from [SBD*13]}}
