...
In Figures \ref{fig:ttt_eps_0_2}, \ref{fig:ttt_eps_0_4}, \ref{fig:ttt_eps_0_6} and \ref{fig:tttExpectedGain} the behaviour of the system under variations of the exploration rate are shown.
